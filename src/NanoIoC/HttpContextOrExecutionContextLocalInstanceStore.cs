...
namespace NanoIoC
{
	...
	sealed class HttpContextOrExecutionContextLocalInstanceStore : InstanceStore
	{
		...
		public HttpContextOrExecutionContextLocalInstanceStore(IContainer container)
		{
		...
		{
			var instanceStore = new HttpContextOrExecutionContextLocalInstanceStore(this.container);
